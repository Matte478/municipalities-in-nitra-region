                ...
                <div class="col-md-6 order-md-2">
                    <div class="card__name">
                        @if($city->coat_of_arms_path)
                            <img class="card__name_image" src="{{ $city->coat_of_arms_path }}" alt="{{ $city->name }}" />
                        @endif
                    ...
                    <div class="card__info">
                        <table class="table card__info_table">
                            ...
                            <tr>
                                ...
                                <td class="table__data"><address>{{ $city->city_hall_address }}</address></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="table__data">
                                    @foreach (explode(',', $city->web) as $web)
                                        <a href="{{ strpos($web, 'http') === false ? "https://{$web}" : $web }}" target="_blank">{{ $web }}</a>
                                        @if(!$loop->last)<br />@endif
                                    @endforeach
                                </td>
                            </tr>
